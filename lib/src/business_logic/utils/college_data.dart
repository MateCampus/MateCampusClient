class CollegeData {
  ...
  static final Map<String, Map<String, String>> data = {
    ...
    'college0040': {'name': '연세대학교', 'image': '\u{1F601}'},
    'college0041': {'name': '육군사관학교', 'image': '\u{1F601}'},
    'college0042': {'name': '이화여자대학교', 'image': '\u{1F1F7}'},
    'college0043': {'name': '인덕대학교', 'image': '\u{1F4B5}'},
    'college0044': {'name': '정화예술대학교', 'image': '\u{2708}'},
    'college0045': {'name': '중앙대학교', 'image': '\u{2600}'},
    'college0046': {'name': '총신대학교', 'image': '\u{1F308}'},
    'college0047': {'name': '추계예술대학교', 'image': '\u{1F3AE}'},
    'college0048': {'name': '충남대학교', 'image': '\u{1F308}'},
    'college0049': {'name': '한국과학기술원', 'image': '\u{1F3AE}'},

    'college0050': {'name': '한국예술종합학교', 'image': '\u{1F601}'},
    'college0051': {'name': '한국외국어대학교', 'image': '\u{1F601}'},
    'college0052': {'name': '한국체육대학교', 'image': '\u{1F1F7}'},
    'college0053': {'name': '한국폴리텍대학', 'image': '\u{1F4B5}'},
    'college0054': {'name': '한성대학교', 'image': '\u{2708}'},
    'college0055': {'name': '한양대학교', 'image': '\u{2600}'},
    'college0056': {'name': '한양여자대학교', 'image': '\u{1F308}'},
    'college0057': {'name': '홍익대학교', 'image': '\u{1F3AE}'},

...
import 'package:zamongcampus/src/ui/common_components/shimmer_components/main_loading/main_loading.dart';
...
class HomeViewModel extends BaseModel {
  ...
  int currentTab = 0;
  Widget currentScreen = const MainLoadingPage(); // Dummy 말고 다른 보편적 페이지 구성 필요

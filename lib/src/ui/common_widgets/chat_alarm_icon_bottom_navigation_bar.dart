...
class ChatAlarmIconBottomNavigationBar extends StatelessWidget {
  final Widget widget;
  const ChatAlarmIconBottomNavigationBar({ Key? key, required this.widget }) : super(key: key);
    ...
    if (homeViewModel.unreadChatMessageCount ==0){
      ...
      return Badge(
            ...
            badgeContent: Padding(
              ...
              child: Text(homeViewModel.unreadChatMessageCount.toString(), style: TextStyle(color: Colors.white, fontSize: resizeFont(12)),),
            ),

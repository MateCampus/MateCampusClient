...
class TextChatInputField extends StatefulWidget {
  final VoiceDetailViewModel vm;
  const TextChatInputField({Key? key, required this.vm}) : super(key: key);

  @override
  _TextChatInputFieldState createState() => _TextChatInputFieldState();
}

class _TextChatInputFieldState extends State<TextChatInputField> {
